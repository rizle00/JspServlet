            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link" href="list.cus">고객관리</a></li>
                        <li class="nav-item"><a class="nav-link" href="list.hr">HR조회</a></li>
                        <li class="nav-item"><a class="nav-link" href="list.jstl">JSTL 연습</a></li>
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">당신의 삶</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">지금 나의 시간은 Mybatis 에게....</p>
                        <a class="btn btn-primary btn-xl" href="#about">Servlet 속으로..</a>
                    </div>
                </div>
            </div>
        </header>
